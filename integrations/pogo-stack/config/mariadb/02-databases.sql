...
CREATE DATABASE IF NOT EXISTS dragonite CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
GRANT ALL PRIVILEGES ON golbat.* TO 'pogo'@'%';
GRANT ALL PRIVILEGES ON reactmap.* TO 'pogo'@'%';
GRANT ALL PRIVILEGES ON koji.* TO 'pogo'@'%';
GRANT ALL PRIVILEGES ON poracle.* TO 'pogo'@'%';
GRANT ALL PRIVILEGES ON dragonite.* TO 'pogo'@'%';
FLUSH PRIVILEGES;
